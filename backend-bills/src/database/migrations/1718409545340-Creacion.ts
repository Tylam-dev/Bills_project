...
export class Creacion1718409545340 implements MigrationInterface {
    name = 'Creacion1718409545340'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "bills_product" ("id" SERIAL NOT NULL, "quatity" integer NOT NULL, "cost_unit" double precision NOT NULL, "bills_id" integer, "products_id" integer, CONSTRAINT "PK_e5f768960f884793b5d7deacc83" PRIMARY KEY ("id"))`);
